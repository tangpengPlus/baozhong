...
/**
* @ClassName: MerchantRedpacketSettingRequest 
* @Description: TODO(商家红包设置请求类) 
* @author 胡竞
* @date 2017年11月20日 下午7:13:47 
*
 */
public class MerchantRedpacketSettingRequest extends BasePojo{
