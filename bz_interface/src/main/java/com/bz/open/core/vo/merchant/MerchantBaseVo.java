package com.bz.open.core.vo.merchant;
 ...
 * 作者: 彭云山
 * 描述:商户类
 * 创建时间:2017年11月9日下午3:43:02
 * 修改备注:
 */
public class MerchantBaseVo extends BasePojo{
	
	private static final long serialVersionUID = 9177859830968340652L;
