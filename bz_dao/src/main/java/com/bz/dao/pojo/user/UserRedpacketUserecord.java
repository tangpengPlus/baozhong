...
/**
  ...
  */
public class UserRedpacketUserecord extends BasePojo {
    /**
     * 用户红包使用记录ID
     ...
     * This field corresponds to the database table user_redpacket_userecord
     *
     * @mbg.generated Wed Nov 01 14:06:11 CST 2017
     */
